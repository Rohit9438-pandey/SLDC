    ...
    <header className="header-contact">
      ...
      <div className="contact-right">
        <div className="contact-info">
          ...
          <span>{translations.contactNo}</span>: <a href="tel:+91352645768">{translations.phoneNumbers}</a> {/* Dynamic phone numbers */}
        </div>
        <div className="email-info">
          <i className="fas fa-envelope" style={{ marginRight: '8px' }}></i>
          <span>{translations.emailUs}</span>: <a href="mailto:info@uksldc.in">{translations.emailAddress}</a> {/* Dynamic email */}
        </div>
      </div>
    </header>
  );
