...
const TransmissionBillCharges = () => {
  ...
  const [searchTerm, setSearchTerm] = useState('');
   ...
   const congestionData = useMemo(() => {
    const filtered = data.filter(item => {
      const isCongestionType = item[1] === 'T' || 
                               (item[4] && item[4].toLowerCase().includes('transmissionBillCharges'));
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white p-4 text-center relative overflow-hidden">
      ...
      <h1 className="text-3xl font-bold mb-1 relative z-10">Transmission Charges Bill</h1>
    </div>
...
export default TransmissionBillCharges;