...
const CongestionCharges = () => {
  ...
  const congestionData = useMemo(() => {
    const filtered = data.filter(item => {
      // Filter for congestion charges based on EA_TYPE = 'C' or description containing 'congestion'
      const isCongestionType = item[1] === 'C' || 
                               (item[4] && item[4].toLowerCase().includes('congestion'));
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white p-4 text-center relative overflow-hidden">
      ...
      <h1 className="text-3xl font-bold mb-1 relative z-10">Congestion Charges Bill</h1>
