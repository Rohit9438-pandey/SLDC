...
const SourceWiseSales = () => {
  ...
  const [searchTerm, setSearchTerm] = useState('');
   ...
   const congestionData = useMemo(() => {
    const filtered = data.filter(item => {
      const isCongestionType = item[1] === 'E' || 
                               (item[4] && item[4].toLowerCase().includes('sourcewisesales'));
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white p-4 text-center relative overflow-hidden">
      ...
      <h1 className="text-3xl font-bold mb-1 relative z-10">Source-wise Sale/purchase of Energy</h1>
    </div>
...
export default SourceWiseSales;