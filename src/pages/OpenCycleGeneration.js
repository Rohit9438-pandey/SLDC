...
const OpenCycleGeneration = () => {
  ...
  const congestionData = useMemo(() => {
    const filtered = data.filter(item => {
      // Filter based on EA_TYPE = 'O' 
      const isCongestionType = item[1] === 'O' || 
                               (item[4] && item[4].toLowerCase().includes('OpenCycleGeneration'));
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white p-4 text-center relative overflow-hidden">
      ...
      <h1 className="text-3xl font-bold mb-1 relative z-10">Open Cycle Generation</h1>
    </div>
...
export default OpenCycleGeneration;